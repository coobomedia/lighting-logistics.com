					...
					<p>
						...
						<select name="<?php echo $this->get_field_name('transition'); ?>" id="<?php echo $this->get_field_id('transition'); ?>">	
							...
							<?php foreach($cycle_transitions as $key => $transition_options): ?>
								...
								<option value="<?php echo esc_attr($key) ?>" <?php if($transition == $key): echo 'selected="SELECTED"'; endif; ?>><?php echo esc_html($transition_options['label']); ?></option>
							<?php endforeach; ?>
							</optgroup>
							<?php if ($ip): ?>
							...
							<?php foreach($cycle_transitions as $key => $transition_options): ?>
								...
								<option value="<?php echo esc_attr($key) ?>" <?php if($transition == $key): echo 'selected="SELECTED"'; endif; ?> <?php if(!$ip): echo 'disabled="disabled"'; endif; ?>><?php echo esc_html($transition_options['label']); ?></option>
							<?php endforeach; ?>
							</optgroup>
						</select>
						<?php if (!$ip): ?>
