...
?>	
			<div class="bikeshed bikeshed_textarea">
				<div class="textarea_wrapper">
					<textarea name="<?php echo esc_attr($field_name); ?>" id="<?php echo esc_attr($field_id); ?>" rows="4" <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?>><?php echo esc_html($options['value']); ?></textarea>
				</div>
				<?php if(!empty($options['description'])): ?>
				<p class="description"><?php _e($options['description']);?></p>
				<?php endif; ?>				
			...
			<div class="bikeshed bikeshed_text">
				<div class="text_wrapper">
					<?php
						...
						$class_attr = sprintf('class="%s"', esc_attr($class_str));
					?>
					<input type="text" name="<?php echo esc_attr($field_name); ?>" id="<?php echo esc_attr($field_id); ?>" value="<?php echo esc_attr($options['value']); ?>" <?php echo $class_attr; ?> <?php echo ($options['disabled'] ? 'disabled="disabled"' : ''); ?> />
				</div>
				<?php if(!empty($options['description'])): ?>
				<p class="description"><?php _e($options['description']);?></p>
				<?php endif; ?>				
