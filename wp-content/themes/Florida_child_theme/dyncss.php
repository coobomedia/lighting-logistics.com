...
define ( 'THEME_ABS_PATH', str_replace("\\", "/", $_SERVER['DOCUMENT_ROOT'].'/wp-content/themes/florida-wp'));
...
if(isset($thm_options['webnus_menu_current_item_border_item_color']) && $thm_options['webnus_menu_current_item_border_item_color']!='')
{
	...
	echo "#header.super-fixed #nav > li.current > a { color: ".$thm_options['webnus_menu_current_item_border_item_color']."};}";
}
