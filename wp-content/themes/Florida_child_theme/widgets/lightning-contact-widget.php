...
class LightningContactForm extends WP_Widget{
	...
	function __construct(){
		...
		parent::__construct('LightningContactForm', '', $params);
	...
	public function widget($args, $instance){
		...
		<?php echo $before_title.$title.$after_title; ?>
			<?php if( $webnus_options->webnus_contact_address() ) { ?>
					<span><i class="icomoon-home"></i> <?php echo $webnus_options->webnus_contact_address(); ?></span>
			<?php } ?>
			<?php if( $webnus_options->webnus_contact_phone() ) { ?>
					<span><i class="icomoon-phone"></i> <?php echo $webnus_options->webnus_contact_phone(); ?></span>
			<?php } ?>
			<?php if( $webnus_options->webnus_contact_email() ) { ?>
					<span><i class="icomoon-envelop-2"></i> <?php echo $webnus_options->webnus_contact_email(); ?></span>
			<?php } ?>
